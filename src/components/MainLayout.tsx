...
const MainLayout: React.FC<MainLayoutProps> = ({
     ...
     const handleDragEnd = (event: DragEndEvent) => {
          ...
          if (active?.data?.current?.type === 'COMPONENT_LIB_ITEM' && over?.id) {
               const activeId = active.id as string;
               const overId = over.id as string;
               if (activeId !== overId && componentOrder) {
                              ...
                              {isPreviewMode && (
                                   ...
                                   >
                                        ...
                                        >
                                             ...
                                             <ToggleGroupItem value="desktop" title="Desktop View" className="p-2">
                                                  <Monitor size={18} className="text-gray-400 size={18} dark:text-gray-300" />
                                             </ToggleGroupItem>
                                        </ToggleGroup>
                                   </motion.div>
                              )}
