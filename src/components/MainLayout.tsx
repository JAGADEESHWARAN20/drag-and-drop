               ...
               <nav className="flex items-center justify-between p-3 bg-white dark:bg-gray-800 shadow-md">
                    <div className="flex items-center space-x-3">
                         <Sheet open={isComponentPanelOpen} onOpenChange={setIsComponentPanelOpen}>
                              ...
                              <SheetContent
                                   side="top"
                                   className={`w-full h-auto max-h-96 p-4 flex flex-col scroll-componentcontainer overflow-x-scroll  ${isMobile ? 'min-w-[100vw]' : 'min-w-[300px]'}`}
                              >
                                   ...
                                   <div className="relative">
                                        <div
                                             ...
                                             className="pb-2 scroll-componentcontainer overflow-x-scroll"
                                        >
